...
namespace TransitApi.Migrations
{
    ...
    [Migration("20260507155139_AddAdminSupport")]
            ...
            modelBuilder.Entity("TransitApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsAdmin = false,
                            PasswordHash = "$2a$11$5xQAyMyPNpiu7LxpPQeBTu.g6PdN6Z6vxxVYSJimnMTZ903ymqwVm",
                            Username = "testuser"
                        },
                        new
                        {
                            ...
                            IsAdmin = true,
                            PasswordHash = "$2a$11$im8qXXOOa5Zz3HPC5ipA0uHbLzhM/rqI.R.KJh2/H79WW0maDBXLu",
                            Username = "admin"
                        });
                });
